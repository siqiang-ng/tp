...
public class EditCommand extends Command {
    ...
    public static class EditPersonDescriptor {
        ...
        public void setTelegramAddress(TelegramAddress telegramAddress) {
            this.telegramAddress = telegramAddress;
        }

        public Optional<TelegramAddress> getTelegramAddress() {
            return Optional.ofNullable(telegramAddress);
        }
