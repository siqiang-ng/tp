...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonProjactStorage projactStorage =
                new JsonProjactStorage(temporaryFolder.resolve("projact.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(projactStorage, userPrefsStorage);
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        // Setup LogicManager with JsonProjactIoExceptionThrowingStub
        JsonProjactStorage projactStorage =
                new JsonProjactIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionProjact.json"));
     ...
     */
    private static class JsonProjactIoExceptionThrowingStub extends JsonProjactStorage {
        private JsonProjactIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
