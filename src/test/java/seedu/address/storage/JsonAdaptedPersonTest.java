...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedTagName> VALID_TAGS = BENSON.getTags().stream()
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        List<JsonAdaptedTagName> invalidTags = new ArrayList<>(VALID_TAGS);
        invalidTags.add(new JsonAdaptedTagName(INVALID_TAG));
        JsonAdaptedPerson person =
